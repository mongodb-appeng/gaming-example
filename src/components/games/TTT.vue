<template>
  ...
  <div>
    <table class="game-table">
      <tbody>
        <tr v-for="(row, i) in gameData">
          <td v-for="(cell, j) in row" :class="{'filled': cell !== ''}" @click="cellClick($event, i, j)"
            @mouseenter="cellHighlight" @mouseleave="cellHighlight">{{cell}}</td>
        </tr>
      </tbody>
    </table>
    <div class="info-bar">
      ...
      <button @click="letsGo">START NEW  &nbsp;<i class="fas fa-play-circle fa-fw"></i></button>
      <button @click="resetScreen">RESET SCORES</button>
    </div>
    <div class="overlay-message" v-if="isGameOver">
      ...
      <button @click="startGame">One more time  &nbsp; <i class="fas fa-play-circle"></i> </button>
    </div>
  </div>
</template>
