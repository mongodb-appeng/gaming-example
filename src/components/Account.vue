    ...
    <div v-if="hasUserLoggedIn">
      ...
      <section class="hero is-small is-link is-bold">
        <div class="hero-body">
          <div class="container">
            <h1 class="title">
              Howdy, <form action="" v-on:submit.prevent>
                <vue-form-generator :schema="schema.name" :model="model.name" :options="formOptions">
                </vue-form-generator>
              </form>
            </h1>
          </div>
      ...
      <div class="columns ">
        <div class="column notification is-primary">
          <p class="title">Social Details</p>
          <hr>
          <form action="" v-on:submit.prevent>
            <vue-form-generator :schema="schema.social" :model="model.social" :options="formOptions">
            </vue-form-generator>
          </form>
        </div>
        <div class="column notification is-info">
          <p class="title">Auth Provider(s)</p>
          <hr>
          <form action="" v-on:submit.prevent>
            <vue-form-generator :schema="schema.auth" :model="model.auth">
            </vue-form-generator>
          </form>
        </div>
      </div>
